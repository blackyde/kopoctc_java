...
public class PolylineBarChart {
    ...
    public static void main(final String[] args) {
       ...
       PolylineBarChart demo = new PolylineBarChart();
             ...
             ChartFrame frame1=new ChartFrame("Bar Chart Example",chart);
    ...
    public JFreeChart getChart() {
        ...
        dataset12.addValue(6.4, "S2", "9월");

        dataset12.addValue(2.7, "S2", "10월");

        dataset12.addValue(1.0, "S2", "11월");

        dataset12.addValue(0.5, "S2", "12월");
